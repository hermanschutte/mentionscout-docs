...
<Steps>
  ...
  <Step title="Runs">
    A **run** is one prompt answered by one model at one point in time. MentionScout sends each prompt to the answer engines you picked (ChatGPT, Claude, Gemini, Perplexity, Grok, Google AI Overviews, Google AI Mode) on a schedule, and stores the full answer.
  </Step>
