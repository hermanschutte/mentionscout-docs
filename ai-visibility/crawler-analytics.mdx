...
<Steps>
  ...
  <Step title="Cited">
    Crawled pages that then showed up in AI answers. The subtext shows your **citation rate**, the share of crawled pages that get cited. If you have no crawled pages yet it reads `Needs crawled pages first`.
  </Step>
  <Step title="Clicked">
...
A line under the heading reports raw activity for the current day, for example how many crawler visits and AI-referral clicks were recorded today. The funnel and the tables below it refresh hourly, so today's raw counts can move ahead of the rolled-up metrics.
