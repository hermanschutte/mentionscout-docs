---
title: "Runs"
description: "Every prompt-to-engine execution, and how to read a single run."
icon: "list-checks"
---
...
<Frame caption="The Runs table lists every prompt-to-engine execution, most recent first.">
...
Each row is a single prompt sent to a single engine (ChatGPT, Claude, Gemini, Perplexity, Grok, Google AI Overviews, or Google AI Mode). MentionScout captures the answer, then parses it for your brand, competitor mentions, sentiment, and citations. Those parsed results are what feed the Mentions and Citations pages.
